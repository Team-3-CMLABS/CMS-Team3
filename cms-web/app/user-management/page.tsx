...
export default function UserManagementPage() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const errorMessage = err instanceof Error ? err.message : "Gagal menyimpan user";
            Swal.fire({
                icon: "error",
    ...
    const handleToggleActive = async (user: User) => {
        ...
        try {
            ...
            const errorMessage = err instanceof Error ? err.message : "Terjadi kesalahan saat toggle status.";
            Toast.fire({ icon: "error", title: errorMessage });
        }
    };
    ...
    const filteredUsers = users
        ...
        .sort((a, b) => {
            ...
            if (sortOption === "recent") return (b.id_user ?? 0) - (a.id_user ?? 0);
            if (sortOption === "oldest") return (a.id_user ?? 0) - (b.id_user ?? 0);
            return 0;
        });
