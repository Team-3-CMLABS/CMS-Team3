...
export default function SinglePageHome() {
  ...
  const handleSave = async () => {
    try {
      ...
      const method = modelId ? "PUT" : "POST"; // kalau ada modelId berarti update
      const url = modelId
        ? `http://localhost:4000/api/content-builder/model/${modelId}`
        : `http://localhost:4000/api/content-builder/model`;
