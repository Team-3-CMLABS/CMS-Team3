...
function InputField({ label, value, onChange, disabled, placeholder, note }: InputFieldProps) {
  return (
    <div>
...
function Checkbox({ label, desc }: CheckboxProps) {
  return (
...
function Toggle({ title, desc, checked, onChange }: ToggleProps) {
  return (
